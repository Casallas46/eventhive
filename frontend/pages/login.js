    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-12 bg-slate-50/50">
      <div className="max-w-md w-full">
        <div className="text-center mb-10">
          ...
          <p className="text-slate-500 mt-2 font-medium">Ingresa tus credenciales para acceder a tu cuenta.</p>
        </div>
        ...
        <div className="bg-white p-8 md:p-10 rounded-3xl border border-slate-200 shadow-2xl shadow-slate-200/40 relative overflow-hidden">
          <div className="absolute top-0 right-0 w-32 h-32 bg-primary-500/5 -mr-16 -mt-16 rounded-full blur-3xl"></div>
          ...
          <form className="space-y-6 relative" onSubmit={handleSubmit}>
            ...
            <div>
              <label className="block text-xs font-bold text-slate-700 mb-2 uppercase tracking-widest">Email Corporativo</label>
              <div className="relative">
                ...
                <input 
                  ...
                  placeholder="ejemplo@eventhive.com"
                  required
                />
              </div>
            </div>
            ...
            <div>
              <div className="flex justify-between mb-2">
                ...
                <Link href="#" className="text-xs font-bold text-primary-600 hover:text-primary-700 underline underline-offset-4 decoration-primary-600/30">¿Olvidaste tu clave?</Link>
              </div>
              <div className="relative">
